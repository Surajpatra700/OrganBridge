...
class RequestorFormPage extends StatefulWidget {
  ...
  @override
  State<RequestorFormPage> createState() => _RequestorFormPageState();
}

class _RequestorFormPageState extends State<RequestorFormPage> {
  final firebaseRef = FirebaseDatabase.instance.ref("requestor");
                  ...
                  children: <Widget>[
                    ...
                    TextFormField(
                      ...
                      decoration: InputDecoration(
                        hintStyle: TextStyle(color: Colors.white70),
                        labelStyle: TextStyle(color: Colors.white70),
                        labelText: "Organ Needed",
                        hintText: "Organ Needed",
                        suffixIcon: PopupMenuButton(
                            icon: Icon(Icons.arrow_drop_down,
                                color: Colors.white),
                            itemBuilder: (context) => [
                    ...
                    // TextFormField(
                    //   decoration: InputDecoration(
                    //     labelText: "Submit your Health Status Report",
                    //     enabledBorder: OutlineInputBorder(
                    //         borderRadius: BorderRadius.circular(10.0),
                    //         borderSide: BorderSide(color: Colors.deepPurple)),
                    //     border: OutlineInputBorder(
                        ...
                        onTap: () {
                          ...
                          if (_myFormKey.currentState!.validate()) {
                            firebaseRef.child(id).set({
                              ...
                              // "Preference":
                              //     preferenceController.text.toString(),
